...
@section('content')
    <div class="clearfix row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="p-3 card">
                <form action="{{ route('admin.course-sesson.store', [$user->username, $course]) }}" method="post"
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Content\Course\Sesson\StoreSessonAdminRequest') !!}
@endsection
