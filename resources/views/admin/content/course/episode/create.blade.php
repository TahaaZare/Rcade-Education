...
@section('content')
    <div class="clearfix row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="p-3 card">
                <form action="{{ route('admin.course-episode.store', [$user->username, $course, $sesson]) }}" method="post"
                            ...
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="2" @if (old('status') == 1) selected @endif>
                                            رد شـده !
                                        </option>
                                    </select>
                                    <i class="clear-input">
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Content\Course\Episode\StoreEpisodeAdminRequest') !!}
