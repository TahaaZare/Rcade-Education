    ...
    <div class="clearfix row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="p-3 card">
                ...
                <form action="{{ route('admin.blog.store', $user->username) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="clearfix row">
                        <div class="col-12">
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\Content\Blog\StoreBlogRequest') !!}
